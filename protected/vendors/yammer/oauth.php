...
class YammerPHP {
	...
	function __construct() {
	    ...
	    $config['consumer_key'] = 'RqNSY7HNyXQbZDhoQA22A';
        $config['consumer_secret'] = 'vGFtAyY2ek31AtZFsVH7H6tZ8pizepBKGj503vxgg';
        $config['callbackUrl'] = 'http://innertools.camera360.com/yammer/callback';
    ...
    public function post($url, $data = array()) {
        ...
        $url = 'https://www.yammer.com/api/v1/' . $url;
